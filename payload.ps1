...
$smtp.Credentials = New-Object System.Net.NetworkCredential("devin0812@gmail.com", "Osta-b60");
$smtp.EnableSsl = $true
$Message.From = "devin0812@gmail.com "
$Message.To.Add("devin0812@gmail.com")
